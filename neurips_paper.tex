...
\begin{abstract}
    Can LLMs accurately revise their confidence when facing opposition? To find out, we organized 59 three-round policy debates (opening, rebuttal, final) among ten state-of-the-art LLMs, where models placed private confidence wagers (0-100) on their victory after each round, evaluated by a six-model AI jury. We observed five alarming patterns: First, \textbf{systematic overconfidence} pervaded the debates (average stated confidence of 72.9\% vs.\ an expected 50\% win rate). Second, a paradoxical \textbf{confidence mismatch} emerged where Proposition debaters, despite a lower win rate (28.8\%), expressed higher average confidence than Opposition debaters (74.6\% vs.\ 71.3\%). Third, rather than converging toward rational 50\% confidence, LLMs displayed \textbf{confidence escalation}; their self-assessed win probability increased from 69\% to 78\% throughout debates, regardless of whether they were actually winning or losing. Fourth, logical inconsistency appeared in 71\% of debates, with both sides simultaneously claiming $\geq$75\% likelihood of success, a mathematically impossibility, even when models were knowingly debating identical, equally capable copies of themselves. Finally, we note concerning examples of strategic confidence manipulation when bets were public, raising concerns about the faithfulness of chain-of-thought reasoning, as models implicitly accounted for opponents' confidence without disclosing this in their reasoning. These findings reveal a fundamental metacognitive blind spot that threatens LLM reliability in adversarial, multi-agent, and safety-critical applications that require self-assessment.
\end{abstract}
