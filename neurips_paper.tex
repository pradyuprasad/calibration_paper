...
% This paragraph will summarize the core findings.
...
\paragraph{Human Overconfidence Baselines [NEW SUBSECTION].}
...
\textbf{[NEW SUBSECTION]}

\subsubsection{Identical Model Debates}
\textbf{[NEW DATA, TBA]}
This section will present our ablation study examining whether identical models debating against themselves exhibit the same overconfidence patterns. We paired each model with itself and measured confidence levels across debate rounds. Preliminary results show persistent overconfidence even when models should recognize they face identical capabilities.

\subsubsection{Public vs. Private Confidence}
\textbf{[NEW DATA, TBA]}
We examine whether making confidence assessments public versus private affects strategic behavior. This ablation reveals how LLMs may manipulate confidence statements when they know their opponent will see them, compared to the private betting scenario in our main experiments.

\subsubsection{Explicit 50\% Win Probability Instruction}
\textbf{[NEW DATA, TBA]}
This section presents results from explicitly instructing models that they face an equal opponent with a 50\% baseline probability of winning. We test whether direct prompting can mitigate overconfidence biases.
...
Further analysis of the 71.2\% of debates where both sides claimed high confidence will be presented. \textbf{[ANALYSIS OF LOGICALLY IMPOSSIBLE HIGH CONFIDENCE SCENARIOS, TBA]}
...
\textbf{[NEW SUBSECTION, NEW DATA, TBA]}
This subsection will discuss the effects of public voting and discussion on confidence expression. We will present evidence of strategic bluffing through confidence manipulation and discuss implications for Chain-of-Thought faithfulness. \textbf{[RESULTS FROM PUBLIC CONFIDENCE ABLATION STUDY, TBA]}
...
This section will include an analysis of LLM prediction accuracy. \textbf{[LLM PREDICTION ACCURACY ANALYSIS, TBA]}
