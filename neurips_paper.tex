...
\subsection{Results}
The mean initial confidence across all models was 49.73% ± 12.04 (n=56), with subsequent rounds showing escalation to 52.10% ± 16.56 after first rebuttal, and ultimately reaching 58.64% ± 16.64 in closing statements. This escalation pattern was statistically significant (Opening→Closing Δ=9.00, p=0.0006).
...
\begin{itemize}
    ...
    \item \textbf{qwq-32b:free} exhibited an unusual V-shaped pattern, dropping to 32.19% in middle rounds before rising to 58.12% (net Δ=13.12, p=0.0031)
