...
\begin{figure}[h]
  ...
  % \includegraphics[width=0.8\linewidth]{figures/avg_confidence_vs_expected.pdf}
  \fbox{\rule[-.5cm]{0cm}{4cm} \rule[-.5cm]{5cm}{0cm}} % Placeholder box
  \caption{Average stated confidence across all LLMs and rounds compared to the expected 50\% win rate.}
...
\begin{figure}[h]
  ...
  % \includegraphics[width=0.8\linewidth]{figures/position_bias_confidence_winrate.pdf}
  \fbox{\rule[-.5cm]{0cm}{4cm} \rule[-.5cm]{6cm}{0cm}} % Placeholder box
...
\begin{figure}[h]
  \centering
  % TODO: Replace with figure showing the percentage of debates where both models had high confidence (e.g., >75%)
  % \includegraphics[width=0.6\linewidth]{figures/both_high_confidence_percentage.pdf}
  \fbox{\rule[-.5cm]{0cm}{4cm} \rule[-.5cm]{4cm}{0cm}} % Placeholder box
  \caption{Percentage of debates where both models expressed a confidence of 75\% or higher in at least one round.}
  \label{fig:both_high_confidence}
\end{figure}
...
\begin{figure}[h]
  \centering
  % TODO: Replace with a line chart showing average confidence across rounds for winning vs. losing models. This is key to showing escalation despite losing.
  % \includegraphics[width=0.9\linewidth]{figures/confidence_trend_winner_loser.pdf}
  \fbox{\rule[-.5cm]{0cm}{4cm} \rule[-.5cm]{6cm}{0cm}} % Placeholder box
  \caption{Average confidence across debate rounds for models that ultimately won versus models that ultimately lost.}
